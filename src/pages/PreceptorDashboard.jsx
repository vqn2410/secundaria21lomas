...
const navLinks = [
  ...
  { path: '/dashboard/asistencia', label: 'Asistencia', icon: <ClipboardCheck size={20} /> },
  { path: '/dashboard/estudiantes', label: 'Mi Legajo', icon: <Users size={20} /> },
  { path: '/dashboard/comunicados', label: 'Anuncios', icon: <Megaphone size={20} /> },
];
